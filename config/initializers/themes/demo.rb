...
Spina::Theme.register do |theme|
  ...
  # - Repeater
  theme.parts = [
    {name: "repeater", title: "Repeater", part_type: "Spina::Parts::Repeater", item_name: "item", parts: %w[line headline image]},
    {name: "line", title: "Line", part_type: "Spina::Parts::Line"},
    {name: "excerpt", title: "Excerpt", part_type: "Spina::Parts::MultiLine" },
  ...
  theme.view_templates = [
    ...
    {name: "demo", title: "Demo", parts: %w[excerpt body image_collection image repeater], exclude_from: %w[articles]}
  ]
  ...
  theme.navigations = [
    ...
    {name: "footer_nav", label: "Footer navigation"},
  ]
